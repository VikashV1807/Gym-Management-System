    ...
    <div class="row-fluid">
     ...
     <div class="widget-content">
            ...
            <div class="row-fluid">
                ...
                <br><br><br><br><br><br>
                  <img src="../img/report/stamp-ample.png" width="124px;" alt=""><p class="text-center">Note:AutoGenerated</p> </div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By The</a> </div>
</div>
